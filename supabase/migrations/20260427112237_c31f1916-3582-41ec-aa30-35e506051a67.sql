...
-- Tighten solar_leads
DROP POLICY IF EXISTS "Anyone can view solar leads" ON public.solar_leads;
DROP POLICY IF EXISTS "Anyone can insert solar leads" ON public.solar_leads;

-- Public form submissions stay open (insert only)
